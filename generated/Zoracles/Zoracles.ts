...
export class Zoracles__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Zoracles extends ethereum.SmartContract {
  static bind(address: Address): Zoracles {
    return new Zoracles("Zoracles", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): Zoracles__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Zoracles__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Zoracles__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Zoracles__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
